...
href="resources/css/todaykcal/todaykcal_css.css" />
...
($("<td>",{text:foodlist[i].food_category,name:'category'}));
							 tr.append

($("<td>",{text:foodlist[i].food_name,name:'name'}));
							 tr.append

($("<td>",{text:foodlist[i].food_gram,name:'gram'}));
							 tr.append

($("<td>",{text:foodlist[i].food_kcal,name:'kcal'}));
							 tr.append

($('<td>').append($('<input type="button" value="+" class="addBtn" 

onclick="moveToMyList(this)">').css("width","18px")));
							 table.append(tr);
						 }
						 $("#foodList").replaceWith
...
{text:foodlist[i].food_category,name:'category'}));
						 tr.append($("<td>",

{text:foodlist[i].food_name,name:'name'}));
						 tr.append($("<td>",

{text:foodlist[i].food_gram,name:'gram'}));
						 tr.append($("<td>",

{text:foodlist[i].food_kcal,name:'kcal'}));
						 tr.append($('<td>').append

($('<input type="button" value="+" class="addBtn" onclick="moveToMyList
...
onclick="removeFromMyList(this)">').css("width","18px")));
						 table.append(tr);
					 }
...
<body>
	<div id="wrap">
		...
		<span class="recommendedKcal">${userLogin.name}님의 하루 권

장섭취량</span>
		<span class="recommendedKcal2">${userLogin.kcal} 
...
src="resources/images/index/search_bl.gif" width="18px"
...
name="food_category" id="food_category" onchange="searchFoodByCategory()">
	...
	<option value="패스트푸드">패스트푸드</option>
		...
		<div class="board">	
			...
			<table summary="my_food_kcal_list" 
