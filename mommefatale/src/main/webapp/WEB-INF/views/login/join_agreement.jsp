...
제 1 조 (목적) 
이 이용약관(이하 '약관')은 mommefatale(이하 회사라 합니다)과 이용 고객(이하 '회원')간에 회사가 제공하는 서비스의 가입조건 및 이용에 관한 제반 사항과 기타 필요한 사항을 구체적으로 규정함을 목적으로 합니다. 
	 
제 2 조 (이용약관의 효력 및 변경) 
(1) 이 약관은 본 회사에 가입된 고객을 포함하여 서비스를 이용하고자 하는 모든 이용자에 대하여 서비스 메뉴 및 회사에 게시하여 공시하거나 기타의 방법으로 고객에게 공지함으로써 그 효력을 발생합니다. 
약관의 게시는 mommefatale 사이트에서 확인 할 수 있습니다 
...
제 7 조 (개인정보의 보호 및 사용) 
회사는 관계법령이 정하는 바에 따라 서비스 이용자의 개인정보를 보호하기 위해 개인정보보호정책을 시행합니다. 이용자 개인정보의 보호 및 사용에 대해서는 관련법령 및 회사의 개인정보 보호정책이 적용됩니다. 
그러나, 회사는 이용자의 귀책사유로 인해 노출된 정보에 대해서 일체의 책임을 지지 않습니다. 
...
4. 개인정보 보유 및 이용기간
㈎ mommefatale의 회원정보 보유기간은 회원이 서비스를 이용하는 기간동안만 정보를 보유하고 있습니다.
㈏ 탈퇴회원인 경우 해당 고객의 개인정보는 지체없이 파기됩니다. 단, 잔여처리사항이 있을 경우 잔여처리 사항이 완료되는 즉시 파기합니다.
㈘ 이용약관 10조에 의해 부적절한 회원은 서비스 이용제한 및 정지회원은 선의의 회원들을 보호하기 위하여, 추후 재가입을 막기 위한 일부 개인정보가 시스템에 남아 있을 수 있으나 3개월후에는 모두 파기됩니다.
(이 경우 회사는 보관하는 정보를 그 보관의 목적으로만 이용합니다.)
 
5. 개인정보 제공 및 공유
㈎ 업무상 mommefatale 관련부서에 최소한의 이용자 정보 (성명, 주소, 전화번호)를 제공할 수 있습니다. 
...
비회원의 경우 보다더 신용있는 서비스를 위하여, 실명여부와 서비스이용시 반드시 필요한 개인정보만을 수집하고 있습니다. 
㈏ 비회원 고객 개인정보 이용 범위 
...
㈏ 네트워크 보안 
mommefatale에서는 국내유수의 웹호스팅서비스를 이용하고 있으며, 이곳은 시스템 및 네트워크의 철저한 보안을 위해 침입방지시스템을 운영하고 있습니다. 
새로운 해커 기술에 대비하여 주기적인 업그레이드 및 시스템을 점검하고, 상시 보안시스템을 모니터링하는 등 철저히 보안을 하고 있습니다. 
㈐ 내부 보안 대책 
① mommefatale에서는 개인정보 관리업무에 대한 권한 및 인력을 최소한으로 한정하여 운영하고 있습니다. 
② mommefatale에서는 회원 고객 본인의 요청에 의해 개인정보를 취급할 때 회원이 본인임을 판단할 수 있는 모든 방법을 동원하여 확인하며, 개인정보가 보다 안전하게 관리되도록 최선을 다하고 있습니다.
㈑ 회원 고객의 보안 의무 
① 회원의 ID와 비밀번호는 본인만이 이용해서 개인정보에 접근하여야 하며, 이러한 개인 정보에 대한 비밀유지 책임은 본인에게 있습니다. 
만약 사용자 본인이 본인의 ID와 비밀번호를 유출하여 발생된 문제에 대해서는 mommefatale에서 책임을 지지 않습니다. 그러므로 회원의 ID와 비밀번호는 보안에 신경쓰셔야 합니다. 
 
② 회원 고객께서는 mommefatale 회원ID로 로그인하여 웹사이트를 이용한 경우 반드시 로그아웃으로 종료하고
웹브라우저 창을 닫아야 컴퓨터를 공유하거나 공공장소에서 컴퓨터를 사용할 경우에도 보안이 됩니다.  
