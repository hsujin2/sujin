...
<body>
	...
	<div class="joinagreement_wrap">
		<div align="center" class="joinagree_body">
			...
			<div class="joinagree_body2">
				
				
				<textarea class="textarea1" name="textarea1">
				
제 1 장 총 칙 

제 1 조 (목적) 
이 이용약관(이하 '약관')은 mommefatale(이하 회사라 합니다)과 이용 고객(이하 '회원')간에 회사가 제공하는 서비스의 가입조건 및 이용에 관한 제반 사항과 기타 필요한 사항을 구체적으로 규정함을 목적으로 
합니다. 
	 
제 2 조 (이용약관의 효력 및 변경) 
(1) 이 약관은 본 회사에 가입된 고객을 포함하여 서비스를 이용하고자 하는 모든 이용자에 대하여 서비스 메뉴 및 회사에 게시하여 공시하거나 기타의 방법으로 고객에게 공지함으로써 그 효력을 발생합
니다. 약관의 게시는 mommefatale 사이트에서 확인 
할 수 있읍니다 
...
(2) 본 이용약관에 대한 동의는 신청시 롤펌 사이트의 '동의' 버튼을 누름으로써 의사표시를 합니다. 
 
제 6 조 (서비스 이용 신청) 
(1) 본 서비스를 이용하고자 하는 이용고객은 회사에서 요청하는 정보(성명, 주민등록번호, 연락처 등)를 제공하여 회원으로 가입한 후 이용이 가능합니다 
...
제 7 조 (개인정보의 보호 및 사용) 
회사는 관계법령이 정하는 바에 따라 서비스 이용자의 개인정보를 보호하기 위해 개인정보보호정책을 시행합니다. 이용자 개인정보의 보호 및 사용에 대해서는 관련법령 및 회사의 개인정보 보호정책이 
적용됩니다. 그러나, 회사는 이용자의 귀책사유로 인해 노출된 정보에 대해서 일체의 책임을 지지 않습니다. 
...
1. 회사는 회원으로 부터 제기되는 의견이나 불만이 정당하다고 인정할 경우에는 즉시 처리하여야 합니다. 다만, 즉시 처리가 곤란한 경우에는 회원에게 그 사유와 처리일정을 서면, 전자우편 또는 전화등
으로 통보하여야 합니다. 
 
2. 회사는 회사가 제정한 개인정보보호정책에 따라서 이용고객의 개인정보를 보호할 의무를 가집니다. 단, 법률의 규정에 따른 적법한 절차에 의한 경우에는 그러하지 않을 수 있습니다. 
 
3. 회사가 제 2 항의 규정에도 불구하고 고지 또는 명시한 범위를 초과하여 이용고객의 개인 정보를 이용하거나 제 3 자에게 제공하고자 하는 경우에는 반드시 해당 회원에게 개별적으로 공지하여 동의를 
받아야 합니다. 
 
4. 회사는 계속적이고 안정적인 서비스의 제공을 위하여 설비에 장애가 생기거나 멸실된 때에는 지체없이 이를 수리 또는 복구합니다. 다만, 천재지변, 비상사태 또는 그밖에 부득이한 경우에는 그 서비스
를 일시 중단하거나 중지할 수 있습니다. 
 
5. 회사는 이용계약의 체결, 계약사항의 변경 및 해지 등 회원과의 계약관련 절차 및 내용등에 있어 회원에게 편의를 제공해야 합니다. 
 
6. 회사는 업무와 관련하여 회원의 사전동의 하에 회원전체 또는 일부의 개인정보에 관한 통계자료를 작성하여 이를 사용할 수 있고 서비스를 통하여 회원의 컴퓨터에 쿠키를 전송 할 수 있습니다. 이 경우 
회원은 쿠키의 수신을 거부하거나 쿠키의 수신에 대하여 경고하도록 사용하는 컴퓨터의 브라우저의 설정을 변경할 수 있으며, 쿠키의 설정 변경에 의한 서비스 이용이 변경되는 것은 회원의 책임입니다. 
...
제 11 조 (서비스 이용 시간) 
(1) 서비스 이용은 회사의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간 운영을 원칙으로 합니다. 단, 회사는 시스템 정기점검, 증설 및 교체를 위해 회사가 정한 날이나 시간에 서비스를 
일시중단할 수 있으며, 예정되어 있는 작업으로 인한 서비스 일시중단은 웹을 통해 사전에 공지합니다. 
(2) 회사는 회사가 통제할 수 없는 사유로 인한 서비스중단의 경우(시스템관리자의 고의,과실없는 디스크장애, 시스템다운 등)에 사전통지가 불가능하며 타인(PC통신회사, 기간통신사업자 등)의 고의,과
...
(1) 회사가 회원에게 서비스를 제공할 수 있는 서비스 투자기반의 일부는 광고게재를 통한 수익으로부터 나옵니다. 회원은 서비스 이용시 노출되는 광고게재에 대해 동의합니?¤. 
...
제 17 조 (계약 변경 및 해지) 
회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 롤펌 웹 내의 "회원탈퇴"메뉴를 이용해 가입해지를 해야 합니다. 
...
3. 회원이 서비스를 이용함에 있어 행한 불법행위로 인하여 회사가 당해 회원 이외에 제 3 자로부터 손해배상 청구, 소송을 비롯한 각종의 이의제기를 받는 경우 당해 회원은 회사의 면책을 위하여 노력하
여야 하며, 만일 회사가 면책되지 못한 경우는 당해 회원은 그로 인하여 회사에 발생한 모든 손해를 배상하여야 합니다. 
...
이 약관은 2014년 6월 9일부터 시행합니다. 
				</textarea>
				<br/>
				
				<div class="agree1">
				회원약관에 동의하시겠습니까?
				<input type="checkbox" value="1" name="agreeCh1" onclick="agreebtn2()"></input>
				동의합니다.
				</div>
...
mommefatale을 찾아 주시는분들에게 만족할 만한 서비스를 하기 위해 최선을 다하고 있으며, 특히 개인정보보호를 매우 중요시하며, 회사에 제공한 개인정보 보호에 만전을 기하고 있습니다. mommefatale의 『개인정보 보호정책』은 정부의 법률과 mommefatale의 정책에 따라 변경될 수 있으니 회원께서는 수시로 확인하여 주시기 바랍니다. 
개인정보 보호정책을 홈페이지 첫 화면하단에 공개함으로써 이용자들이 언제나 용이하게 보실 수 있도록 조치하고 있습니다.
 
1. 개인정보 수집 목적 및 이용
㈎ mommefatale에서는 회원이 각종 서비스를 최대한 편리하게 이용할 수 있도록 하고, 편리하고 
정확하게 처리하기 위한 최소한의 필요 정보를 수집하고 있습니다. 
㈏ 회원 개개인의 정보는 회원 본인이 직접 관리하실 수 있도록 “회원정보”란을 두고 있습니다. 
㈐ 본래의 목적 외에는 사용하지 않는 것을 원칙으로 합니다.
 
2. 개인정보 수집에 대한 동의  
 
회사는 이용자들이 회사의 개인정보 보호정책 또는 이용약관의 내용에 대하여 “확인” “가입하기” “체크” 버튼등을 클릭하여 mommefatale의 서비스를 이용하면, 개인정보 수집에대해 동의한 것으로 봅니다.
3. 개인정보 수집 항목
㈎ 성명 
㈏ 주민등록번호 
㈐ 주소  
...
㈕ 사업자등록번호(해당회원인 경우) 
㈖ 회사명(해당회원인 경우) 
㈗ 부가정보(맞춤 서비스를 하기 위한 것으로 고객이 원하는 경우에만 수집)
 
 
4. 개인정보 보유 및 이용기간
㈎ mommefatale의 회원정보 보유기간은 회원이 서비스를 이용하는 기간동안만 정보를 보유하고 
있습니다.
㈏ 탈퇴회원인 경우 해당 고객의 개인정보는 지체없이 파기됩니다. 단, 잔여처리사항이 있을 경우 잔여처
리 사항이 완료되는 즉시 파기합니다.
㈘ 이용약관 10조에 의해 부적절한 회원은 서비스 이용제한 및 정지회원은 선의의 회원들을 보호하기 위
하여, 추후 재가입을 막기 위한 일부 개인정보가 시스템에 남아 있을 수 있으나 3개월후에는 모두 파기됩
니다.(이 경우 회사는 보관하는 정보를 그 보관의 목적으로만 이용합니다.)
 
5. 개인정보 제공 및 공유
㈎ 업무상 mommefatale 관련부서에 최소한의 이용자 정보 (성명, 주소, 전화번호)를 제공할 수 
있습니다. 
㈏ 통계작성, 학술연구 또는 시장조사를 위하여 필요한 경우로서 특정 개인을 식별할 수 없는 형태로 제공
할 수 있습니다.
㈑ 다음의 경우는 고객 및 회원의 동의 없이 개인정보를 제공할 수 있습니다.  
① 서비스 이용 약관 또는 정책을 위반한 경우  
② 서비스를 이용하여 타인에게 정신적, 물질적 피해를 줌으로써 그에 대한 법적인 조치를 취하거나, 또다
른 피해를 방지하기 위하여 개인정보를 공개해야 한다고 판단되는 충분한 근거가 있는 경우  
③ 상거래의 투명성을 위해 제공해야 할 필요한 정보가 있는 경우 
④ 적법한 법적인 조치가 요구되거나, 관련 정부기관의 요구가 있을 경우
㈒ 서비스 이용주체가 입력한 식별정보(주민등록번호,성명)가 본인 실명여부의 확인 및 공공의 목적을 위
해 신용정보집중기관으로 제공, 활용될 수 있습니다.  
 
6. 비회원 고객 개인정보 보호
㈎ 비회원 고객 개인정보 수집 목적 및 이유 
회원뿐만 아니라 비회원인 고객도 각종 서비스를 이용하실 수 있습니다. 
비회원의 경우 보다더 신용있는 서비스를 위하여, 실명여부와 서비스이용시 반드시 필요한 개인정보만을
수집하고 있습니다. 
㈏ 비회원 고객 개인정보 이용 범위 
mommefatale에서 비회원 고객의 자료는 실명확인, 각종게시물 관리를 위한 비회원로그인에 관련한 용도로만 사용됩니다.
 
 
7. 개인정보 열람, 변경 및 탈퇴
㈎ 회원은 언제든지 자신의 개인정보를 열람, 변경, 탈퇴를 할 수 있습니다. 
㈏ 개인정보의 열람, 변경, 탈퇴는 로그인 후 “정보수정” 메뉴에서 직접 열람, 변경, 탈퇴할 수 있습니다. 
㈐ 또한 개인정보와 관련하여 불만이나 의견을 메일로 보내 주시면 
접수 즉시 조치하여 처리결과를 통보하여 드립니다.
 
 
8. 고객 개인정보 보호를 위한 보안대책
㈎ 쿠키(Cookie) 운영 
mommefatale에서는 회원인증을 위하여 쿠키방식을 사용하고 있습니다. 
쿠키에 기록되었던 정보는 웹브라우저를 닫거나 로그아웃을 하면 자동으로 삭제되도록 되어 있습니다.
㈏ 네트워크 보안 
mommefatale에서는 국내유수의 웹호스팅서비스를 이용하고 있으며, 이곳은 시스템 및 네트워크
의 철저한 보안을 위해 침입방지시스템을 운영하고 있습니다. 새로운 해커 기술에 대비하여 주기적인 업
그레이드 및 시스템을 점검하고, 상시 보안시스템을 모니터링하는 등 철저히 보안을 하고 있습니다.  
 
㈐ 내부 보안 대책 
① mommefatale에서는 개인정보 관리업무에 대한 권한 및 인력을 최소한으로 한정하여 운영하고 있습니다. 
② mommefatale에서는 회원 고객 본인의 요청에 의해 개인정보를 취급할 때 회원이 본인임을 판단할 수 있는
모든 방법을 동원하여 확인하며, 개인정보가 보다 안전하게 관리되도록 최선을 다하고 있습니다.
㈑ 회원 고객의 보안 의무 
① 회원의 ID와 비밀번호는 본인만이 이용해서 개인정보에 접근하여야 하며, 이러한 개인 정보에 대한 비
밀유지 책임은 본인에게 있습니다. 만약 사용자 본인이 본인의 ID와 비밀번호를 유출하여 발생된 문제에 
대해서는 mommefatale에서 책임을 지지 않습니다. 그러므로 회원의 ID와 비밀번호는 보안에 신
경쓰셔야 합니다. 
 
② 회원 고객께서는 mommefatale 회원ID로 로그인하여 웹사이트를 이용한 경우 반드시 로그아웃으로 종료하고
웹브라우저 창을 닫아야 컴퓨터를 공유하거나 공공장소에서 컴퓨터를 사용할 경우에도 
보안이 됩니다.  

				</textarea>
					<div class="agree2">
					회원약관에 동의하시겠습니까?
					<input type="checkbox" value="1" name="agreeCh2" onclick="agreebtn1()"></input>
					동의합니다.
					</div>
				...
				<br><br>
				<hr>
				<div class="joinagree_end">
					<img onclick="agreeCheck()" src="resources/images/login/confirm.png">
					
					<a href ="login.do"><img src="resources/images/login/cancle.png"></a>
				</div>
				<!-- kbwjoin_end -->
